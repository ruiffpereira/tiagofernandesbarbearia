      ...
      <section className="grid lg:grid-cols-[1.1fr_1fr] min-h-[calc(100vh-64px)]">
        ...
        >
          ...
          <div className="relative max-w-[520px] self-center">
            ...
            <p
              className="text-[clamp(15px,1.6vw,17px)] text-ink-soft leading-relaxed max-w-[440px] mb-8
        ...
        <div
          className="order-1 lg:order-2 flex flex-col justify-center bg-cream-dark
          px-5 sm:px-10 lg:px-12 py-7 lg:py-12"
        >
          <div
            className="w-full max-w-[480px] mx-auto bg-paper border border-line rounded-xl2
